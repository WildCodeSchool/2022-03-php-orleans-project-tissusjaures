...
(2, "Détacher un linge", "/assets/images/tache.jpg", "Epongez la tâche avec un papier absorbant et un fer chaud. Frottez ensuite avec du savon de Marseille sec que vous laisserez agir quelques minutes. Rincez à l'eau chaude.", 0),
(3, "Taches de bougie", "/assets/images/tachebougie.jpg", "Une tâche de bougie sur votre vêtement ou votre sol? Prenez un buvard et déposé le sur la tâche. Passez ensuite un fer à repasser bien chaud sur le buvard. La cire va se décoller se venir se déposer sur le buvard. ", 0),
(4, "Taches de peintures", "/assets/images/tachepeinture.jpg", "Trempez les vêtements tachés de peinture immédiatement dans du lait puis lavez normalement. Cette astuce est notamment utilisée dans les écoles maternelles.", 0),
(5, "Coudre de la toile cirée", "/assets/images/toilecirer.jpeg", "Pour coudre de la toile enduite, nous recommandons un pied presseur RN téflon.
