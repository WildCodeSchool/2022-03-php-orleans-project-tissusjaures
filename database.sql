...
INSERT INTO `tutorials` (`id`, `name`, `image`, `content`) VALUES
(1, "Confectionner des rideaux", "/assets/images/tss1.jpg", "La hauteur du rideau = Haut de la barre au sol + 3cm.
La hauteur du tissu = Hauteur du rideaux + 20cm pour les ourlets."),
...
Bien mesurer avant de percer ! Les supports se placent à environ 10cm du bout de la tringle."),
(3, "Conseil déco", "/assets/images/tss1.jpg", "Votre pièce doit être harmonieuse...
Pourquoi ne pas poser un voilage léger porté par une tringlerie fine, des doubles rideaux sur des tringles de grand diamètre et des embouts de barre pour s'accorder au style de votre intérieur...");
